...
CREATE TABLE activity (
	...
	CONSTRAINT fk_activity_admin FOREIGN KEY(admin_id) REFERENCES admin (id)
);
...
CREATE TABLE spaces (
	...
	CONSTRAINT pk_spaces PRIMARY KEY (app_id),
	CONSTRAINT fk_spaces_app FOREIGN KEY(app_id) REFERENCES app (id)
);

CREATE TABLE artists (
	app_id INT,
	genre_id INT,
	CONSTRAINT pk_artists PRIMARY KEY (app_id, genre_id),
	CONSTRAINT fk_artists_app FOREIGN KEY(app_id) REFERENCES app (id),
...
CREATE TABLE contracts (
	...
	init_hour TIME,
	end_hour TIME,
	musician_rating FLOAT,
	restaurant_rating FLOAT,
	CONSTRAINT pk_contract PRIMARY KEY (artist_id, space_id),
	CONSTRAINT fk_contract_artist FOREIGN KEY(artist_id) REFERENCES app (id),
	CONSTRAINT fk_contract_space FOREIGN KEY(space_id) REFERENCES app (id)
);
...
CREATE TABLE incidences (
	...
	CONSTRAINT pk_incidences PRIMARY KEY (app_id, admin_id),
	CONSTRAINT fk_incidences_app FOREIGN KEY(app_id) REFERENCES app (id),
	CONSTRAINT fk_incidences_admin FOREIGN KEY(admin_id) REFERENCES admin (id)
);
GO